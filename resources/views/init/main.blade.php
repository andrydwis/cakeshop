...
<div class="section-body">
    <div class="row">
        <div class="col-12 mb-4">
            <div class="hero align-items-center hero-bg-image text-white hero-bg-image" style="background-image: url('/assets/img/hero.jpg')">
    ...
    <div class="row d-flex align-items-stretch">
        <div class="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
            <img src="{{asset('assets/img/world.svg')}}" alt="" class="img-fluid d-none d-sm-none d-md-block">
        </div>
